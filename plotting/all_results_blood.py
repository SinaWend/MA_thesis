...
def process_log(file_path, hyperparameters, output_dir):
    ...
    # Initialize headers
    headers = "param_index, method, mname, commit, algo, epos, te_d, seed, params, acc, precision, recall, specificity, f1, auroc, acc_oracle, acc_val, model_selection_epoch, experiment_duration\n"
    ...
    for block in experiment_blocks:
        ...
        for domain, (domain_title, result_list) in domains.items():
            ...
            for match in epoch_matches:
                ...
                result_line = f"{param_index}, {method}, mname_{mname}_seed_{seed}, commit_b44271c83_not_commited, {algo}, {epoch}, center0, {seed}, {params}, {data['acc']}, {data['precision']}, {data['recall']}, {data['specificity']}, {data['f1']}, {data['auroc']}, , , , , \n"
...
log_dir_path = '/home/aih/sina.wendrich/MA_thesis/zoutput_blood/benchmarks/BLOOD_acevedo_resnet_different_models_acevedo_2024-08-11_12-18-51'
...
def combine_results(directory, result_type):
    combined_results = ["param_index, method, mname, commit, algo, epos, te_d, seed, params, acc, precision, recall, specificity, f1, auroc, acc_oracle, acc_val, model_selection_epoch, experiment_duration\n"]
    seen_lines = set()
